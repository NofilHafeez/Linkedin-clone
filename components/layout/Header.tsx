...
import { Search, Home, Users, MessageSquare, Bell, User, Grid3X3 } from 'lucide-react';
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search"
                className="w-64 pl-10 bg-zinc-700 pr-4 py-2 rounded-md text-sm focus:outline-none focus:ring-1   transition-colors"
              />
            </div>
          </div>
